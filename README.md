...
- **Printer**  
  A Litematica-style printing tool integrated into SleepyAddon. It can:
  - Automatically place schematic blocks in survival
  - Automatically mine **wrong** and **extra** blocks (blocks that shouldn’t be there according to the schematic)
